...
import com.eMarket.online.respository.EmarketCategoryRepository;
import com.eMarket.online.respository.EmarketProductRepository;
import com.eMarket.online.respository.EmarketSubCategoryRepository;
...
public class EMarketOnlineApplication {
	 ...
	 */
	@Bean
	CommandLineRunner start (EmarketCategoryRepository categoryRepository, EmarketProductRepository productRepository, EmarketSubCategoryRepository subcategoryRepository) {
		
		repositoryRestConfiguration.exposeIdsFor(EmarketProduct.class, EmarketCategory.class, EmarketSubCategory.class);
		
		return args->{
			categoryRepository.deleteAll();
			subcategoryRepository.deleteAll();
			Stream.of("Tv Tv Disponible", "Smartphone Smartphone Disponible", "Laptop Laptop Disponible").forEach(cat -> {
				categoryRepository.save(new EmarketCategory(cat.split(" ")[0], cat.split(" ")[1], cat.split(" ")[2], "design_app", true, new ArrayList<>()));
			});
