...
public class EMarketOnlineApplication {
	...
	CommandLineRunner start (CategoryRepository categoryRepository, ProductRepository productRepository, SubcategoryRepository subcategoryRepository) {
		...
		return args->{
			...
			Product p1_1 = productRepository.save(new Product(null, ("PRD" +UUID.randomUUID().toString().substring(20).toUpperCase()), "Samsung S7", "The new Samsung s7 available in the OnlineShopping Store", 45000, 32000, true, EmarketUtils.percentReductuon(45000, 32000), "https://i.gadgets360cdn.com/products/large/1555507135_635_samsung_galaxy_a60.jpg", 3, true, 15, 3, 20, subcategory1));
			Product p2 = productRepository.save(new Product(null, ("PRD" +UUID.randomUUID().toString().substring(20).toUpperCase()), "Iphone 11", "The new Iphone 11 available in the OnlineShopping Store", 32000, 15000, false, EmarketUtils.percentReductuon(32000, 15000), "https://store.storeimages.cdn-apple.com/4668/as-images.apple.com/is/MWYK2?wid=1144&hei=1144&fmt=jpeg&qlt=80&op_usm=0.5,0.5&.v=1567304928359", 7, true, 45, 23, 89, subcategory2));
			Product p1_2 = productRepository.save(new Product(null, ("PRD" +UUID.randomUUID().toString().substring(20).toUpperCase()), "Samsung Galaxy A20", "The new Samsung Galaxy A20 available in the OnlineShopping Store", 3000, 2500, true, EmarketUtils.percentReductuon(3000, 2500), "https://www.cellularishop.com/1848-large_default/samsung-galaxy-a20e-32gb-black-italia-no-brand-dual-sim.jpg", 8, true, 22, 13, 10, subcategory1));
			Product p3 = productRepository.save(new Product(null, ("PRD" +UUID.randomUUID().toString().substring(20).toUpperCase()), "Nokia 3310", "The new Nokia 3310 available in the OnlineShopping Store", 2500, 1000, true, EmarketUtils.percentReductuon(2500, 1000), "https://www.mytrendyphone.it/images/Nokia-3310-Factory-Refurbished-Dark-Blue-14082018-01-p.jpg", 4, true, 100, 50, 150, subcategory3));
			Product p4 = productRepository.save(new Product(null, ("PRD" +UUID.randomUUID().toString().substring(20).toUpperCase()), "Wiko Lenny5", "The new Wiko Lenny5 available in the OnlineShopping Store", 3300, 2000, false, EmarketUtils.percentReductuon(3300, 2000), "https://s3.eu-central-1.amazonaws.com/static2.euronics.it/immagini/img-catalogo-converted/full/192005940.jpg", 5, true, 89, 11, 50, subcategory4));
			...
			Product pd1 = productRepository.save(new Product(null, ("PRD" +UUID.randomUUID().toString().substring(20).toUpperCase()), "Samsung Smart Tv, 4K Ultra Hd Wi-Fi Nero", "The new Samsung Smart Tv available in the OnlineShopping Store", 345000, 232000, true, EmarketUtils.percentReductuon(345000, 232000), "https://images-na.ssl-images-amazon.com/images/I/91uZe9P9LgL._SX425_.jpg", 23, true, 25, 23, 120, sub1));
			Product pd2 = productRepository.save(new Product(null, ("PRD" +UUID.randomUUID().toString().substring(20).toUpperCase()), "Akkai AKTV3222T 32pc HD Smart TV Wi-Fi White DVB T/2 - LED TVs", "The new Akkai AKTV3222T available in the OnlineShopping Store", 202000, 115000, true, EmarketUtils.percentReductuon(202000, 115000), "https://images-eu.ssl-images-amazon.com/images/I/41shAK7vJCL._SL500_AC_SS350_.jpg", 17, true, 45, 23, 89, sub2));
			Product pd3 = productRepository.save(new Product(null, ("PRD" +UUID.randomUUID().toString().substring(20).toUpperCase()), "Smart TV LG 65UM7000PLA 65' 4K Ultra HD LED WiFi Nero", "The new Smart TV LG available in the OnlineShopping Store", 523300, 452000, false, EmarketUtils.percentReductuon(523300, 452000), "https://images-na.ssl-images-amazon.com/images/I/817kIItUz9L._SX466_.jpg", 5, false, 89, 11, 50, sub3));
